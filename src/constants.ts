...
export const TRANSLATIONS: Record<Language, any> = {
  ka: {
    ui: {
      ...
      heroDesc: "სათავგადასავლო თამაშები Fort-Boyard-ის სტილში",
      ...
      product: "პროდუქტი",
      company: "კომპანია",
      copyright: "©2026 made by codezero.ge all rights reserved lost lock",
      session: "სესია",
    ...
    obstacles: [
      { id: 'marao', name: 'მარაო', category: 'ოთახები', image: 'https://framerusercontent.com/images/K2dowoaqgVolSPYbUKOWyy1UoSU.png', images: [], video: '', link: '#marao', description: 'მარაო არის ერთ-ერთი ყველაზე დახვეწილი და ტექნიკური დაბრკოლება Lost-Lock-ში. აქ მოთამაშეებს მოუწევთ წონასწორობის დაცვა და სწრაფი რეაგირება.' },
      { id: 'train', name: 'მატარებელი', category: 'ოთახები', image: 'https://framerusercontent.com/images/mnQSusjkG57QxShJ3V7dADvJEDg.png', images: [], video: '', link: '#train', description: 'მატარებლის ოთახი გადაგიყვანთ ნამდვილ სათავგადასავლო ატმოსფეროში.' },
      { id: 'numbers', name: 'ციფრები', category: 'ოთახები', image: 'https://framerusercontent.com/images/uMFgcLNLDKCjhlXiiwGov4.png', images: [], video: '', link: '#numbers', description: 'ლოგიკური აზროვნების და მათემატიკური სიზუსტის ოთახი.' },
      { id: 'sawdust', name: 'ნახერხი', category: 'ოთახები', image: 'https://framerusercontent.com/images/U0teqXy7OH15n2opOH6yRxEZs0.png', images: [], video: '', link: '#sawdust', description: 'ფიზიკური აქტივობის და გართობის იდეალური ნაზავი.' },
      { id: 'prison', name: 'საპატიმრო', category: 'ოთახები', image: 'https://framerusercontent.com/images/hiHkPliV1IV1VKmr7Ig9zfCgs.png', images: [], video: '', link: '#prison', description: 'გახდით ციხიდან გაქცევის გმირი.' },
      { id: 'balls', name: 'ბურთები', category: 'ოთახები', image: 'https://framerusercontent.com/images/OZBSyU26cOuTNmRGtAlPSXm0Tlc.png', images: [], video: '', link: '#balls', description: 'მხიარული და ფერადი ოთახი, სადაც ბურთების ზღვაში უნდა იპოვოთ საჭირო გასაღებები.' },
      { id: 'pipe', name: 'მილი', category: 'ოთახები', image: 'https://framerusercontent.com/images/2uIu8Q8FZT92tV7oyJbNaeXYKw.png', images: [], video: '', link: '#pipe', description: 'ვიწრო გასასვლელები და რთული მარშრუტები.' },
      { id: 'golf', name: 'გოლფი', category: 'ოთახები', image: 'https://framerusercontent.com/images/k3SnFvBIk9U5QWL2JQxZJuMhOb4.png', images: [], video: '', link: '#golf', description: 'სიზუსტე და სიმშვიდე - ეს არის ის, რაც გოლფის ოთახში დაგჭირდებათ.' }
    ],
    services: [
      { id: 'photo', name: 'პროფესიონალი ფოტოგრაფი', price: '80₾', category: 'სერვისები', image: 'https://framerusercontent.com/images/U3jr0GoG94uk4hJKsWOBqVs6WA8.webp', images: [], video: '', link: '#photo', description: 'პროფესიონალური ფოტო გადაღება.' },
      { id: 'video', name: 'პროფესიონალური ვიდეო გადაღება+მონტაჟი', price: '150₾', category: 'სერვისები', image: 'https://framerusercontent.com/images/U3jr0GoG94uk4hJKsWOBqVs6WA8.webp', images: [], video: '', link: '#video', description: 'პროფესიონალური ვიდეო გადაღება და მონტაჟი.' },
      { id: 'xbox_laser', name: 'XBOX ცეკვები, ლაზერ შოუ, სკანერები', price: '80₾', category: 'სერვისები', image: 'https://framerusercontent.com/images/hiHkPliV1IV1VKmr7Ig9zfCgs.png', images: [], video: '', link: '#xbox_laser', description: 'ტორტის ჩაქრობის ცერემონია და სპეცეფექტები.' },
      { id: 'animator_ru', name: 'რუსულენოვანი ანიმატორი', price: '150₾', category: 'სერვისები', image: 'https://framerusercontent.com/images/mnQSusjkG57QxShJ3V7dADvJEDg.png', images: [], video: '', link: '#animator_ru', description: 'პროფესიონალი ანიმატორი რუსულენოვანი ბავშვებისთვის.' },
      { id: 'animator_en', name: 'ინგლისურენოვანი ანიმატორი', price: '150₾', category: 'სერვისები', image: 'https://framerusercontent.com/images/OZBSyU26cOuTNmRGtAlPSXm0Tlc.png', images: [], video: '', link: '#animator_en', description: 'პროფესიონალი ანიმატორი ინგლისურენოვანი ბავშვებისთვის.' },
      { id: 'barman', name: 'ბარმენ შოუ', price: '300₾', category: 'სერვისები', image: 'https://framerusercontent.com/images/2uIu8Q8FZT92tV7oyJbNaeXYKw.png', images: [], video: '', link: '#barman', description: 'კოქტეილ წვეულება და სანახაობრივი ბარმენ შოუ.' }
    ],
    pricing: [
  ...
  en: {
    ...
    obstacles: [
      { id: 'marao', name: 'The Fan', category: 'Rooms', image: 'https://framerusercontent.com/images/K2dowoaqgVolSPYbUKOWyy1UoSU.png', images: [], video: '', link: '#marao', description: 'The Fan is one of the most sophisticated technical obstacles in Lost-Lock.' },
      { id: 'train', name: 'The Train', category: 'Rooms', image: 'https://framerusercontent.com/images/mnQSusjkG57QxShJ3V7dADvJEDg.png', images: [], video: '', link: '#train', description: 'The Train room takes you into a real adventure atmosphere.' },
      { id: 'numbers', name: 'Numbers', category: 'Rooms', image: 'https://framerusercontent.com/images/uMFgcLNLDKCjhlXiiwGov4.png', images: [], video: '', link: '#numbers', description: 'Room for logical thinking and mathematical precision.' },
      { id: 'sawdust', name: 'Sawdust', category: 'Rooms', image: 'https://framerusercontent.com/images/U0teqXy7OH15n2opOH6yRxEZs0.png', images: [], video: '', link: '#sawdust', description: 'Perfect mix of physical activity and fun.' },
      { id: 'prison', name: 'Prison', category: 'Rooms', image: 'https://framerusercontent.com/images/hiHkPliV1IV1VKmr7Ig9zfCgs.png', images: [], video: '', link: '#prison', description: 'Become a prison break hero.' },
      { id: 'balls', name: 'Ball Pit', category: 'Rooms', image: 'https://framerusercontent.com/images/OZBSyU26cOuTNmRGtAlPSXm0Tlc.png', images: [], video: '', link: '#balls', description: 'Fun and colorful room where you must find keys hidden in a sea of balls.' },
      { id: 'pipe', name: 'The Pipe', category: 'Rooms', image: 'https://framerusercontent.com/images/2uIu8Q8FZT92tV7oyJbNaeXYKw.png', images: [], video: '', link: '#pipe', description: 'Narrow passages and difficult routes.' },
      { id: 'golf', name: 'Golf', category: 'Rooms', image: 'https://framerusercontent.com/images/k3SnFvBIk9U5QWL2JQxZJuMhOb4.png', images: [], video: '', link: '#golf', description: 'Precision and calm - that\'s what you\'ll need.' }
    ],
    services: [
      { id: 'photo', name: 'Photographer', price: '80₾', category: 'Services', image: 'https://framerusercontent.com/images/U3jr0GoG94uk4hJKsWOBqVs6WA8.webp', images: [], video: '', link: '#photo', description: 'Professional photo session.' },
      { id: 'video', name: 'Video Production', price: '150₾', category: 'Services', image: 'https://framerusercontent.com/images/U3jr0GoG94uk4hJKsWOBqVs6WA8.webp', images: [], video: '', link: '#video', description: 'Professional video shooting and editing.' },
      { id: 'xbox_laser', name: 'XBOX, Laser Show, Scanners', price: '80₾', category: 'Services', image: 'https://framerusercontent.com/images/hiHkPliV1IV1VKmr7Ig9zfCgs.png', images: [], video: '', link: '#xbox_laser', description: 'Cake ceremony special effects.' },
      { id: 'animator_ru', name: 'Russian Animator', price: '150₾', category: 'Services', image: 'https://framerusercontent.com/images/mnQSusjkG57QxShJ3V7dADvJEDg.png', images: [], video: '', link: '#animator_ru', description: 'Professional animator for Russian-speaking kids.' },
      { id: 'animator_en', name: 'English Animator', price: '150₾', category: 'Services', image: 'https://framerusercontent.com/images/OZBSyU26cOuTNmRGtAlPSXm0Tlc.png', images: [], video: '', link: '#animator_en', description: 'Professional animator for English-speaking kids.' },
      { id: 'barman', name: 'Barman Show', price: '300₾', category: 'Services', image: 'https://framerusercontent.com/images/2uIu8Q8FZT92tV7oyJbNaeXYKw.png', images: [], video: '', link: '#barman', description: 'Cocktail party and spectacular barman show.' }
    ],
    pricing: [
