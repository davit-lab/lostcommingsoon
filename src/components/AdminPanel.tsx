...
import { ArrowLeft, Save, RotateCcw, LogOut, Image, Type, DollarSign, FileText, UtensilsCrossed, HelpCircle, ShieldCheck, Palette, ChevronDown, Plus, Trash2 } from 'lucide-react';
...
type Tab = 'assets' | 'ui_ka' | 'ui_en' | 'rooms_ka' | 'rooms_en' | 'services_ka' | 'services_en' | 'pricing_ka' | 'pricing_en' | 'menu_ka' | 'menu_en' | 'faq_ka' | 'faq_en' | 'rules_ka' | 'rules_en' | 'nav_ka' | 'nav_en' | 'background';
      ...
      case 'assets':
        return (
          <div className="flex flex-col gap-6">
            ...
            <InputField label="Logo URL" value={assets.logo} onChange={(v) => { updateAssets({ logo: v }); showSaved(); }} />
